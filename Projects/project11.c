		...
		while(1)
		{
			...
			if(ch == '1')    //login, message type = 1
			{
				if(loginFlag == 0)
				{
					...
					//Print the result
					if(strcmp(receive.text1,"Login successfully") == 0)
					{	
						loginFlag = 1;
						printf("%s\n\n",receive.text1);
					}
				...
				{
					printf("You are already logged in, Log out to login with different account ^_^\n");
			...
			{	
				...
				{
					printf("You are already logged out ^_^\n");
	...
	else		
	{
		...
		{	
			...
			{	
				...
				int ch = 0;
				char username1[100]= "sp1999";
				char password1[100]= "sp1999";
				
				//Check if the username and password are correct
				
					
					if(strcmp(username1,receive.text1) == 0)
					{
						if(strcmp(password1,receive.text2) == 0)
						{
							ch = 1;
